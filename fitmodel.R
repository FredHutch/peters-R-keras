...
layer_conv_1d(filters = 64, kernel_size = 1, activation = 'relu',kernel_regularizer = regularizer_l1_l2(0.01,0.01),
               input_shape = c(ncol(x_train),1)) %>%
#layer_max_pooling_1d(pool_size = 2) %>%
layer_flatten()%>%
layer_dense(units = 64, kernel_regularizer = regularizer_l1_l2(0.01,0.01), activation = 'relu') %>%
...
layer_dense(units = 64, kernel_regularizer = regularizer_l1_l2(0.01,0.01), activation = 'relu') %>%
layer_dropout(rate = 0.001) %>%
layer_dense(units = 32, kernel_regularizer = regularizer_l1_l2(0.01,0.01), activation = 'relu') %>%
layer_dropout(rate = 0.001) %>%
