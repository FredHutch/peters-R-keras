...
parallel_model %>%
 layer_dense(units = 64, kernel_regularizer = regularizer_l2(0.01), activation = 'relu', input_shape = c(ncol(x_train))) %>%
 layer_dropout(rate = 0.2) %>%
 layer_dense(units = 64, kernel_regularizer = regularizer_l2(0.01), activation = 'relu') %>%
 layer_dropout(rate = 0.2) %>%
 layer_dense(units = 32, kernel_regularizer = regularizer_l2(0.01), activation = 'relu') %>%
layer_dropout(rate = 0.2) %>%
 layer_dense(units = 320, kernel_regularizer = regularizer_l2(0.01), activation = 'relu') %>%
 layer_dropout(rate = 0.2) %>%
 layer_dense(units = 12, kernel_regularizer = regularizer_l2(0.01), activation = 'relu') %>%
 layer_dropout(rate = 0.2) %>%
