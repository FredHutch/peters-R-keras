...
parallel_model %>%
 layer_dense(units = 64, kernel_regularizer = regularizer_l2(0.0001), activation = 'exponential', input_shape = c(ncol(x_train))) %>%
 layer_dropout(rate = 0.001) %>%
 layer_dense(units = 64, kernel_regularizer = regularizer_l2(0.0001), activation = 'exponential') %>%
 layer_dropout(rate = 0.001) %>%
layer_dense(units = 64, kernel_regularizer = regularizer_l2(0.0001), activation = 'exponential') %>%
layer_dropout(rate = 0.001) %>%
 layer_dense(units = 64, kernel_regularizer = regularizer_l2(0.0001), activation = 'exponential') %>%
