...
layer_dense(units = 2000, kernel_regularizer = regularizer_l2(0.01), activation = 'relu', input_shape = c(30000)) %>%
  layer_dropout(rate = 0) %>%
 # layer_dense(units = 2000, kernel_regularizer = regularizer_l2(0.01), activation = 'tanh') %>%
layer_dense(units = 2000, kernel_regularizer = regularizer_l2(0.01), activation = 'relu') %>%
  layer_dropout(rate = 0) %>%
